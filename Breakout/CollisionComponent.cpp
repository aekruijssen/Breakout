	...
	const CollisionComponent* other, Vector2& offset)
{
	...
	//difference = “other” side minus “this” side
	...
	//If you collide with the left / right side of “other”, change offset.x
	if (lowest == dx1) {
		offset.x -= dx1;
	...
	//If you collide with the top / bottom side of “other”,  change offset.y
	else if (lowest == dy1) {
		offset.y -= dy1;
		return CollSide::Top;
	}
